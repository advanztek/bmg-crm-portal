...
import { columns, quotation } from "./lib";

/**
 * @param {import("@/types/global.d").ModalConfig} props
 */
export default function QuotationModal({ open, onClose }) {
  return (
    <ModalLayout
      open={open}
      width={{ xs: "800px" }}
    ...
    >
      <Stack gap={spacingTokens.sm}>
        <OutlinedInput placeholder="Basic Quotation" fullWidth />
